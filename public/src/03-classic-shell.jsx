...
const CLASSIC_MODE_META = {
  ...
  // Snakes & Ladders only. The literal "4" mirrors SNL_RANKED_MIN_HUMANS
  // (declared later in load order, in the game's own file — this file can't
  // reference it at module-evaluation time).
  party:  { icon: '🎉', name: 'Party Match',       desc: '2-6 seats, humans and bots, play to last place' },
  ranked: { icon: '🏆', name: 'Ranked Match',      desc: 'Hot-seat, 4+ humans, RP and tiers' },
};
