...
const UNIT_TYPES = Object.freeze({
  miner: Object.freeze({
    name: 'Miner', icon: '⛏', role: 'worker', cost: 100, trainSecs: 2.5,
  ...
  spear: Object.freeze({
    name: 'Spear Guard', icon: '♜', role: 'infantry', cost: 450, trainSecs: 6,
    pop: 2, hp: 220, damage: 27, range: 52, cooldown: 20, speed: 54,
    unlockMission: 3,
  }),
  mage: Object.freeze({
    name: 'Mage', icon: '✦', role: 'ranged', cost: 700, trainSecs: 8,
    pop: 3, hp: 124, damage: 38, range: 235, cooldown: 34, speed: 48,
    projectileSpeed: 235, splash: 72, unlockMission: 4,
  }),
  giant: Object.freeze({
    name: 'Giant', icon: '◆', role: 'infantry', cost: 1100, trainSecs: 12,
