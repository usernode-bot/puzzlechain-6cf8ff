const GAMES = [
  ...
  },
  {
    ...
    shell: 'daily',
    daily: true,
    desc: 'Fill the grid so every row and column matches its number clues.',
    tag: 'Logic',
    tagColor: GA.plum,
    manifest: { scoreDirection: 'higher', tieBreak: 'time-then-steps', sessionLength: 'medium', input: 'tap', undo: 'free' },
    fitShell: true,
    howToPlay: [
      ...
      { title: 'Fill and mark', body: 'Use ⬛ Fill for cells you\'re sure of and ✗ Mark for cells that must stay empty. Both toggle freely, so nothing you tap ends the day.' },
      { title: 'Watch the red numbers', body: 'A clue turns red when that row or column can no longer match it, whatever you do next. The Errors pill counts those lines, and the line above the board tells you where you stand.' },
      { title: 'Score', body: 'The puzzle solves when every clue is satisfied. Fewer taps and faster solves score higher. Filling the whole grid with a picture that does not match the clues counts as a mistake and costs 50 points.' },
    ],
