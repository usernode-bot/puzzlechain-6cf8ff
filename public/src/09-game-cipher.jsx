...
const CW_NATURE = [
  ...
  { word: 'DUNE',     clue: 'A hill the wind builds from sand',                   hints: ['Migrates a little each year', 'Common on desert edges and coasts'] },
  ...
  { word: 'GORGE',    clue: 'A deep narrow valley cut by water',                  hints: ['Steeper and tighter than a valley', 'Rivers carve them over ages'] },
  { word: 'DELTA',    clue: 'Fan of land where a river meets the sea',            hints: ['Named for a Greek letter', 'Built from deposited sediment'] },
  { word: 'MARSH',    clue: 'Low wet ground thick with grasses',                  hints: ['Wetter than a meadow', 'Reeds and herons'] },
  ...
  { word: 'FJORD',    clue: 'A long narrow sea inlet between cliffs',             hints: ['Carved by a glacier', 'Norway has many'] },
  { word: 'GEYSER',   clue: 'A spring that erupts boiling water',                 hints: ['Heated by volcanic rock', 'Old Faithful is one'] },
  { word: 'TUNDRA',   clue: 'Treeless plain where the subsoil stays frozen',      hints: ['Permafrost underneath', 'Arctic and alpine'] },
  { word: 'CANOPY',   clue: 'The leafy roof of a forest',                         hints: ['Where most rainforest life lives', 'Blocks light from the floor'] },
  { word: 'LAGOON',   clue: 'Shallow water separated from the sea by a reef',     hints: ['Calm and often turquoise', 'Ringed by an atoll'] },
  { word: 'THICKET',  clue: 'A dense tangle of shrubs',                           hints: ['Hard to push through', 'Good cover for small animals'] },
  { word: 'ESTUARY',  clue: 'Where a river\'s fresh water meets the tide',         hints: ['Brackish, not fresh or salt', 'Nurseries for young fish'] },
  { word: 'PLATEAU',  clue: 'A raised area of level ground',                      hints: ['Flat on top, steep at the edges', 'Also means "to stop improving"'] },
  { word: 'GLACIER',  clue: 'A river of ice that flows downhill',                 hints: ['Carves valleys as it moves', 'Retreating almost everywhere'] },
  { word: 'MONSOON',  clue: 'Seasonal wind that brings months of rain',           hints: ['Reverses direction twice a year', 'South Asia depends on it'] },
  ...
  { word: 'SUMMIT',   clue: 'The very top of a mountain',                         hints: ['Where the climb ends', 'Also a meeting of leaders'] },
  ...
  { word: 'HABITAT',  clue: 'The place a species lives',                          hints: ['Loss of it drives extinction', 'Where food and shelter are'] },
  ...
  { word: 'CRATER',   clue: 'A bowl-shaped hollow from an impact or eruption',    hints: ['The moon is covered in them', 'Rimmed and round'] },
];
